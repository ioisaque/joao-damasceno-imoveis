<script type='text/javascript'>
	...
	$('#inputCidade').change(function() {
		$('#inputBairro').html('<option value="0">Carregando...</option>');
		
		$.post("buscabairros.php", {cidade:$('#inputCidade').val()},
			function(valor){
				$("#inputBairro").html(valor);
				})
		}
	);
});
									...
									<div class="content">
										<form method="get" action="">
											<div class="location control-group">
												...
												<div class="controls">	
													<select id="inputCidade" name="inputCidade" class="chosen">
											...
											<div class="type control-group">
												...
												<div class="controls">
													<select id="inputTipo" name="inputTipo" class="chosen">
