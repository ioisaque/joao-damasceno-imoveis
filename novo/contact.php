...
*/
$emailto = 'jcdama@yahoo.com.br'; 	// Insert the email address that will receive the messages
$fromName = 'Contato João Damasceno Imóveis';					// Insert a default "Name" email address (this fiel will be displayed in the email header)
$fromEmail = 'contato@joaodamascenoimoveis.com.br';	// Insert a default "From" email address (this fiel will be displayed in the email header)
$subject = 'Contato pelo Site';			// Insert a default conctact form subject
